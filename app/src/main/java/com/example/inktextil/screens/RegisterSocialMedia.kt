...
fun RegisterSocialMediaScreen(
    ...
    Column(
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            SocialCircleButton(R.drawable.facebook_icon, "Registrar con Facebook") { /* Acción Facebook */ }
            SocialCircleButton(R.drawable.google_icon, "Registrar con Google") { /* Acción Google */ }
            SocialCircleButton(R.drawable.twitter_icon, "Registrar con Twitter") { /* Acción Twitter/X */ }
        }
...
fun PreviewRegisterSocialMediaScreen() {
    RegisterSocialMediaScreen(
        onEmailRegister = { /* Acción de prueba */ },
